  ...
  return (
    <BigFooterBox>
      <InnerFooterBox>
        <h3>Contact</h3>
        <p>
          If you're looking for a web developer who’s passionate about the
          details and thrives on solving problems, let's connect! 🚀
        </p>
